...
If you believe you've found a security-related bug, we prefer that you fill out a [vulnerability report on GitHub](https://github.com/kuhl-haus/kuhl-haus-canary/security/advisories/new) directly.  
...
- **Regular Dependency Updates**: We use Dependabot automation to keep dependencies updated. [Dependabot Updates](https://github.com/kuhl-haus/kuhl-haus-canary/actions/workflows/dependabot/dependabot-updates)
